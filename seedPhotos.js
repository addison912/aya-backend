...
let galleries = [
  ...
  { pulished: true, name: "Home", category: "Home" },
  {
    pulished: true,
    name: "Nest",
    category: "Advertising",
  ...
  db.Gallery.deleteMany({}, function (err, objects) {
    ...
    galleries.forEach((galleryData) => {
      var gallery = new db.Gallery({
        pulished: galleryData.published,
